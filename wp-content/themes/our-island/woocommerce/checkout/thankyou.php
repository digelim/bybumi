  ...
  <div class="max-w-3xl mx-auto">
    <div class="max-w-xl">
      ...
      <dl class="mt-12 text-sm font-medium">
        ...
        <dd class="text-gray-500 mt-2"><?php echo wc_format_datetime( $order->get_date_created() );
?></dd>
      </dl>
    </div>
    ...
    if ( $_product && $_product->exists() ) {
        ...
        <li class="flex py-6">
            ...
            <div>
                ...
                <h4 class="text-sm">
                    <a href="<?php echo esc_url( $product_permalink ); ?>" class="font-medium text-gray-700 hover:text-gray-800"> <?php echo $_product->get_title(); ?></a>
                </h4>
                </div>
                ...
                $variation = wc_get_product($cart_item->get_data()['variation_id']);
      ...
      <div class="sm:ml-40 sm:pl-6">
        ...
        <dl class="space-y-6 border-t border-gray-200 text-sm pt-10">
          <div class="flex justify-between">
            ...
            <dd class="text-gray-700"><?php echo wc_price( $order->get_subtotal() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></dd>
          </div>
             ...
             <?php
                ...
                if (sizeof( $codes ) > 0 ) {
                    ...
                    <dd class="text-gray-700">-<?php echo wc_price( $order->get_discount_total() )?></dd>
                    </div>
          ...
          <div class="flex justify-between">
            ...
            <dd class="text-gray-700"><?php echo wc_price( $order->get_shipping_total() ); ?></dd>
          </div>
          <div class="flex justify-between">
