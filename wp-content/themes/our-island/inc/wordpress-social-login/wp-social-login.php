...
var_dump(get_template_directory(  ).'/inc/wordpress-social-login/');
// --------------------------------------------------------------------
/**
...
*/
if( file_exists( get_template_directory(  ).'/inc' . '/wp-social-login-custom.php' ) )
{
	include_once( get_template_directory(  ).'/inc' . '/wp-social-login-custom.php' );
}
...
defined( 'WORDPRESS_SOCIAL_LOGIN_ABS_PATH' )
	|| define( 'WORDPRESS_SOCIAL_LOGIN_ABS_PATH', get_template_directory(  ).'/inc/wordpress-social-login/' );

defined( 'WORDPRESS_SOCIAL_LOGIN_PLUGIN_URL' )
	|| define( 'WORDPRESS_SOCIAL_LOGIN_PLUGIN_URL', get_template_directory_uri(  ).'/inc/wordpress-social-login/' );
