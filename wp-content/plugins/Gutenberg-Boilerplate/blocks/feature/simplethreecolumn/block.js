          ...
          <dl className="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div>
              ...
              <dt>
                ...
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                  ...
                  <MediaUpload onSelect={ media => { setAttributes({ imageUrl: media.url }); } } type="image" render={ ({ open }) => (<img src={ attributes.imageUrl} onClick={ open } className='h-6 w-6'/>)}/>
            ...
            <div>
              ...
              <dt>
                ...
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                  ...
                  <MediaUpload onSelect={ media => { setAttributes({ imageUrlA: media.url }); } } type="image" render={ ({ open }) => (<img src={ attributes.imageUrlA} onClick={ open } className='h-6 w-6'/>)}/>
                </div>
                <p className="mt-5 text-lg leading-6 font-medium text-gray-900">
                  <RichText
            ...
            <div>
              ...
              <dt>
                ...
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                  <MediaUpload onSelect={ media => { setAttributes({ imageUrlB: media.url }); } } type="image" render={ ({ open }) => (<img src={ attributes.imageUrlB} onClick={ open } className='h-6 w-6'/>)}/>
                </div>
                <p className="mt-5 text-lg leading-6 font-medium text-gray-900">
                  <RichText
    ...
    return (
      <div class="py-12 bg-white">
        ...
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <h2 class="sr-only">{attributes.contentUB} </h2>
          <dl class="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div>
              ...
              <dt>
                ...
                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                  <img src={ attributes.imageUrl} class="h-6 w-6"/>
                </div>
            ...
            <div>
              ...
              <dt>
                ...
                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                  ...
                  <img src={ attributes.imageUrlA} class="h-6 w-6"/>
                </div>
                <p class="mt-5 text-lg leading-6 font-medium text-gray-900">
            ...
            <div>
              ...
              <dt>
                ...
                <div class="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                  <img src={ attributes.imageUrlB} class="h-6 w-6"/>
                </div>
                <p class="mt-5 text-lg leading-6 font-medium text-gray-900">
