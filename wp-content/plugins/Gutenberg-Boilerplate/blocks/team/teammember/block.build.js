    ...
    return wp.element.createElement(
      ...
      wp.element.createElement(
        ...
        wp.element.createElement(
          ...
          wp.element.createElement(
            "ul",
            { role: "list", className: "flex justify-center space-x-5" },
            wp.element.createElement(InnerBlocks, { allowedBlocks: ['core/social-links'], template: [['core/social-links']], templateLock: "all" })
          )
        )
      )
    );
