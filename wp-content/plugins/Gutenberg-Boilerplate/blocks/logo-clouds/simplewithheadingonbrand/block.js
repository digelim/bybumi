...
registerBlockType("gb/simplewithheadingonbrand", {
  ...
  attributes: {
    ...
    imageUrlC: {
      ...
      selector: "img",
      default:
        "https://tailwindui.com/img/logos/transistor-logo-indigo-300.svg",
    },
    imageUrlD: {
      attribute: "src",
      selector: "img",
      default:
        "https://tailwindui.com/img/logos/workcation-logo-indigo-300.svg",
    },
    contentt: {
      type: "string",
