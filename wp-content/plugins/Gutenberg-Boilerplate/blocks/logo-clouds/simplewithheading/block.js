        ...
        <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          ...
          <div class="lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <h2 class="max-w-md mx-auto text-3xl font-extrabold text-indigo-900 text-center lg:max-w-xl lg:text-left">
             <RichText.Content value={attributes.contentt}/> default=
              {"The world's most innovative companies use Workflow"} onChange=
              {(newtext) => setAttributes({ contentt: newtext })}
            </h2>
